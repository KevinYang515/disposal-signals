...
with tab1:
    ...
    with col_f1:
        filter_grade = st.multiselect(
            '評級篩選',
            options=['✅ 主力訊號', '⚠️ 漲多但大戶減碼', '🟡 觀察中', '⬜ 待觀察', '❌ 避開', '🆕 新制觀察中'],
            default=['✅ 主力訊號', '⚠️ 漲多但大戶減碼', '🟡 觀察中', '🆕 新制觀察中'],
        )
    with col_f2:
...
🆕 新制觀察中 = 2026/8/10 處置新制（2分鐘撮合、5~7個營業日）下的事件。舊制「主力訊號」等評級是用20分鐘撮合、10天期間驗證出來的，新制機制不同、樣本還不夠，暫不套用舊制信心度，先單純觀察累積資料。
""")
