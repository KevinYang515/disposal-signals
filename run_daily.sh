...
mkdir -p $HOME/disposal/logs
{
  ...
  git add data/signals.csv data/history.csv data/backtest_grid.csv data/meta.json data/signals_5min.csv data/history_5min.csv data/signals_tail20.csv data/history_tail20.csv data/newregime_signals.csv data/newregime_history.csv
