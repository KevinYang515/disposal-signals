...
st.error(
    "⚠️ **回測 Bug 警告（2026-07-01 發現）**：原版回測「09:35 @ morning_high × 0.9995 進場」"
    "這個假設在實盤無法成立——若 09:35 開棒時市場價已跌破觸價，限價單根本掛不到。"
    "修正後的 REALISTIC 版本顯示：原版 **97.3% 的進場單在實盤不可成交**，剩餘真實能成交的 657 筆"
    "Sharpe 從 +29.22 變成 **-5.39**、CAGR 從 +115% 變 **-4%**。\n\n"
    "已嘗試 35 個變體（晚進場、量能、VWAP、失敗反彈、流動性篩選…）均無法做出 Sharpe > 1 的策略。"
    "**目前頁面顯示的訊號僅供研究參考，不可實盤跟單**。"
    "詳細分析見 `D:\\stock\\tmf-bot\\backtest\\REPORT_守不住開盤_崩潰分析.md`"
)
