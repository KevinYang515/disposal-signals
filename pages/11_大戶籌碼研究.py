...
with tab_auto:
    ...
    auto_view = auto_view.rename(columns={
        ...
        "即時監測2026年至今_n": "2026已完成樣本數", "即時監測2026年至今_weekly": "2026每週等權超額(%)",
        "即時監測2026年至今_median": "2026中位超額(%)", "即時監測2026年至今_win": "2026勝過0050比例(%)",
    })
    auto_cols = ["價格結構", "大戶路徑", "大戶增加門檻(pp)", "原始大戶比例上限(%)", "跳升前允許流失(pp)", "穩健分數",
                 ...
                 "2026已完成樣本數", "2026每週等權超額(%)", "2026中位超額(%)", "2026勝過0050比例(%)"]
